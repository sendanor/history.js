...
configs =
	...
	other: [
...

		{
			...
			# Bundling
			bundleScriptPath: __dirname+'/scripts/bundled/html4+html5/native.cjs.history.js'
		}
		{
			# Options
			...
			# Bundling
			bundleScriptPath: __dirname+'/scripts/bundled/html5/native.cjs.history.js'
		}
